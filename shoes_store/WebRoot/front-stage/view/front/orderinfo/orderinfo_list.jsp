...
<html>
	...
	<div id="wrapper">
		...
		<center>
			<display:table name="listtt" class="table" pagesize="10"
				requestURI="/sys/FOrderinfoQueryServlet" export="true">
				...
				<display:column title="修改" value="修改" style="width:50px;"
					...
					url="/sys/FOrderinfoUpdateServlet"></display:column>
				<display:column title="删除" value="删除" style="width:50px;"
					paramId="orderId" paramProperty="orderId"
					url="/sys/FOrderinfoDeleteServlet"></display:column>
			</display:table>
		</center>
	<div id="wrapper">
	</body>
