...
<html>
  <head>
    ...
    <title>My JSP 'sportstrendinfo_list.jsp' starting page</title>
        ...
        <div class="bottomBox">
          <div class="leftBox">
            <div class="box1">
              ...
              <div class="cdBox"><a href="Goos001.html"><img  src="front-stage/img/s10.jpg" width="150" height="113"/></a></div>
			...
			<div class="box1">
			  ...
			  <div class="cdBox"><a href="Goos001.html"><img src="front-stage/img/s11.jpg" width="150" height="113"/></a></div>
			...
			<div class="box1">
              ...
              <div class="cdBox"><a href="Goos001.html"><img src="front-stage/img/s12.jpg" width="150" height="113"/></a></div>
					...
					<div style="font-size:20px;"><a href="#">清凉一夏</a></div>
						<c:forEach items="${listll}" var = "picture">
               				<div class="Lmainbox">
               		 			...
               		 			<div class="Lmainboxtxt"><center>潮牌拖鞋</center></div>
               				</div>	
               			</c:forEach> 
				</div>
				<div class="Lmain">
