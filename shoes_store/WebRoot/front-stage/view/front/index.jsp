            ...
            <div class="wrapper">
				...
				<div class="category">
							...
							<ul id="J_category" class="item">
								<a href="<%=basePath %>sys/ManyGoodsServlet"><li><span> 凉鞋</span></li></a>
								<a href="<%=basePath %>sys/ManyGoodsServlet"><li><span>皮鞋</span></li></a>
								<a href="<%=basePath %>sys/ManyGoodsServlet"><li><span>皮鞋鞋</span></li></a>
								<a href="<%=basePath %>sys/ManyGoodsServlet"><li><span>运动鞋</span></li></a>
								<a href="<%=basePath %>sys/ManyGoodsServlet"><li><span>休闲鞋</span></li></a>
								<a href="<%=basePath %>sys/ManyGoodsServlet"><li><span>儿童鞋</span></li>	</a>										
							</ul>
						</div>
					</div>
					</div>
