...
<html>
  <head>
    ...
    <title>My JSP 'userlogininfo_info.jsp' starting page</title>
          ...
          <div class="workZoneRight">
            <div class="rightBox inner">
              <div style="padding:0 15px 20px 15px;">
                ...
                <div> <br />
                  <br />
                  <form action="<%=basePath %>sys/FUserLoginServlet" method="post">
                    <table width="80%">
                      <tr>
                        <td width="145" align="left" valign="top" class="body" id="Company"><strong>用户名:</strong></td>
                        <td width="280" align="left" valign="top"><input name="userName" type="text" size="40" /></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top" class="body" id="Contact"><strong>输入密码:</strong></td>
                        <td align="left" valign="top"><input name="userPwd" type="password" size="40" /></td>
                      </tr>
                      ...
                      <tr>
                        <td></td>
                        <td><input type="submit" name="submit" class="button" value="登录" /></td>
                      </tr>
                    </table>
                  </form>
                </div>
