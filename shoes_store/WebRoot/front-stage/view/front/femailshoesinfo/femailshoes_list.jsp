...
<html>
  <head>
    ...
    <title>My JSP 'femailshoes_list.jsp' starting page</title>
      ...
      <div class="topBox">
        <div class="bottomBox">
          <div class="leftBox">
            <div class="box1">
              <h1>季度热销款式</h1>
			  <div class="whiteText"> 我个性，我喜欢</div>
              <div class="cdBox"><a href="Goos001.html"><img src="front-stage/img/13.jpg" width="150" height="113"/></a></div>
			...
			<div class="box1">
              <h1>每月热销款式</h1>
			  <div class="whiteText"> 随性街头百搭</div>
              <div class="cdBox"><a href="Goos001.html"><img src="front-stage/img/9.jpg" width="150" height="113"/></a></div>
			...
			<div class="box1">
              <h1>每周热销款式</h1>
			  <div class="whiteText"> 新品首发</div>
              <div class="cdBox"><a href="Goos001.html"><img src="front-stage/img/10.jpg" width="150" height="113"/></a></div>
            ...
            <div class="clear">
				<div class="Lmain">
					<div style="font-size:20px;"><a href="#">清凉一夏</a></div>
               				...
               				<div class="Lmainbox">
               		 			...
               		 			<div class="Lmainboxtxt"><center>夏季风凉鞋</center></div>
               				</div>	
               				</c:forEach>          
				...
				<div class="Lmain">
					<div style="font-size:20px;"><a href="#">活力无限</a></div>
						<c:forEach items="${listtw}" var = "picture">
               				<div class="Lmainbox">
               		 			<div class="Lmainboxpic"><a href="<%=basePath %>sys/DepartGoodsServlet"><img src="${picture.pictureUrl}" width="180" height="200" class="project-img" alt="s" /></a></div>
				...
				<div class="Lmain">
					<div style="font-size:20px;"><a href="#">时尚靓丽</a></div>
						<c:forEach items="${listthr}" var = "picture">
               				<div class="Lmainbox">
               		 			<div class="Lmainboxpic"><a href="<%=basePath %>sys/DepartGoodsServlet"><img src="${picture.pictureUrl}" width="180" height="200" class="project-img" alt="s" /></a></div>
               		 			<div class="Lmainboxtxt"><center>时尚拖鞋</center></div>
               				</div>	
               			</c:forEach>
				</div>
			</div>
